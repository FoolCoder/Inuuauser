...
import MaterialCosmmunityIcons from 'react-native-vector-icons/MaterialCommunityIcons'
...
export default class selectedVendor extends Component {
  ...
  profile = async () => {
    ...
    await AsyncStorage.setItem('PD', JSON.stringify(data))

    this.props.navigation.navigate('vProfile', {
    ...
    if (val2 == null) {
      ...
      if (val == null) {
        if (item.discount > 0) {
          ...
          this.props.navigation.navigate('selectedF', {
            data: item,
            price: price,
          ...
          <View style={{ flex: 1, backgroundColor: '#d2d5cb' }}>
            ...
            <View style={{ flex: 1, marginTop: height(1), backgroundColor: '#f1eff0', borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
              ...
              <View style={{ width: width(90), alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: height(3) }}>
                ...
                <Text style={{ fontSize: totalSize(2.5), width: width(45), textAlign: 'right' }}>
                  Nearby Vendors
                </Text>
                ...
                <View>
                  ...
                  <View style={{
                    ...
                    <Text style={{
                      ...
                      marginStart: width(1), color: '#f7b851',
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <MaterialCosmmunityIcons name='silverware-fork-knife' size={12} />
